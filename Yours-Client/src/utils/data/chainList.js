...
const chainList = [
    ...
    { name: "Solana", logo: SolanaLogo, icon: <SolanaIcon/>, explorerUrl: 'https://solscan.io/tx' },
    { name: "Aptos", logo: AptosLogo, icon: <AptosIcon/>, explorerUrl: 'https://explorer.aptoslabs.com/tx' },
]
